...
- **QUICKSTART_EN.md** - Quick start guide in English
- **QUICKSTART.md** - Quick start guide in French
- **INSTALLATION.md** - Installation guide in English
- **INSTALLATION_FR.md** - Installation guide in French
...
```
PulseEchoGui/
├── PROJECT_INFO_EN.md       # This file (English)
├── PROJECT_INFO.md          # Project info (French)
├── README.md                # Complete documentation (EN)
├── QUICKSTART_EN.md         # Quick guide (EN)
├── QUICKSTART.md            # Quick guide (FR)
├── INSTALLATION.md          # Installation guide (EN)
├── INSTALLATION_FR.md       # Installation guide (FR)
├── LICENSE                  # MIT License
