...
axes[0, 0].axvline(echo_time_expected, color='r', linestyle='--', alpha=0.5, label='Expected echo')
...
axes[0, 1].axvline(echo_time_expected, color='r', linestyle='--', alpha=0.5, label='Expected echo')
...
plt.suptitle(f'Hahn Echo Simulation (τ = {tau}, linewidth = {linewidth})',
